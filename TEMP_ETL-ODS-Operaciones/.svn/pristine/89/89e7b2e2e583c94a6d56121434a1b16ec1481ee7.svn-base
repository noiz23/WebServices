...
//			SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd");
			...
			if (t.contains("1")){
				logger.debug("ValidateTask --> Se Borraran Archivos OK de CallProcedure y LoadView ");
				deleteFileOK(getFileRepository(),getFileName());
				deleteFileOK(getFileRepository(),getLoadViewFile());
				logger.debug("Archivos Borrados satisfactoriamente.");
	...
	private void deleteFileOK(String folderRepository, String fileName) {
	...
	public String getLoadViewFile() {
		return loadViewFile;
	}

	public void setLoadViewFile(String loadViewFile) {
		this.loadViewFile = loadViewFile;
	}
